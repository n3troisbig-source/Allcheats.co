                ...
                <div className="space-y-4">
                  ...
                  <div className="rounded-xl border border-yellow-500/30 bg-yellow-500/5 p-4 space-y-2">
                    ...
                    <p className="text-xs text-gray-300 leading-relaxed">
                      After you send the money, <span className="text-white font-semibold">make a ticket</span> and include:
                    </p>
                ...
                <div className="space-y-4">
                  ...
                  <div className="rounded-xl border border-dark-500 bg-dark-700 p-4 space-y-3">
                    ...
                    <div className="flex items-start gap-2.5 text-xs text-gray-400">
                      ...
                      <span><span className="text-yellow-400 font-bold">Make a ticket</span> after paying — we need proof before delivering</span>
                    </div>
